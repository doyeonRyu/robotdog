...
def bytes_toint(msb, lsb):
    '''
    Function: bytes_toint
    - 두 바이트를 부호 있는 정수로 변환합니다 (빅 엔디안)
    - 리틀 엔디안의 경우 msb, lsb 인수를 반전시킵니다
    - 인터럽트 핸들러에서 사용할 수 있습니다
    '''
    if not msb & 0x80:
        return msb << 8 | lsb  # +ve
...
class Sh3001(I2C):
    """
    class: Sh3001
    - SH3001 센서 클래스 (SH3001: 3축 가속도계 및 3축 자이로스코프, 1축 온도계)
    """
    ...
    ******************************************************************/
    ...
    def _sh3001_getimudata(self):
        """
        Function: _sh3001_getimudata
        - SH3001 센서에서 IMU 데이터를 가져옵니다.
        """
        try:
            gyroData = [0, 0, 0]
            accData = [0, 0, 0]
    ...
    def sh3001_gettempdata(self):
        """
        Function: sh3001_gettempdata
        - SH3001 센서에서 온도 데이터를 가져옵니다.
        """
        tempref = [0, 0]
